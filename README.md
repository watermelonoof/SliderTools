...
<table style="width:100%">
    ...
    <tr>
        <td>assets/BlockImages/ErrorOccurred</td>
    ...
    <tr>
        <td>assets/BlockImages/OnChange</td>
    ...
    <tr>
        <td>assets/BlockImages/OnTouchDown</td>
    ...
    <tr>
        <td>assets/BlockImages/OnTouchUp</td>
    ...
    <tr>
        <td>assets/BlockImages/Register</td>
    ...
    <tr>
        <td>assets/BlockImages/Unregister</td>
